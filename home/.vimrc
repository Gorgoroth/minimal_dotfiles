...
map <F10> :set wrap!<cr>                   " Toggle wrap behaviour
...
function! LoadBundles()
  ...
  let s:vimwiki = {}
  let s:vimwiki.nested_syntaxes = {'ruby': 'ruby','python': 'python','c++': 'cpp'}
  let g:vimwiki_list = [{'path': '~/Dropbox/Privat/Notes/vimwiki/','auto_export': 1,'maxhi': 1}]
  ...
  " Highlight checkboxes and headers
  let g:vimwiki_hl_cb_checked=1
  let g:vimwiki_hl_headers=1
  let g:vimwiki_table_mappings=0
  " Enable folding
  let g:vimwiki_folding='syntax'
  " Enable auto linking of camel case words
  let g:vimwiki_camel_case=1
  " Start auto numbering of headers at level 2
